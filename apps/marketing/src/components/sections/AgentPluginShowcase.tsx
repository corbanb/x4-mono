...
const STAGES: PipelineStage[] = [
  ...
  },
  {
    ...
    glowColor: 'yellow',
    plugin: 'x4',
    headline: 'Describe your app. Get a full plan.',
    description:
      "Tell the AI what you're building. It brainstorms features, designs the UI for each one, sequences the build order, and generates PRDs for every feature — all in one interactive session.",
    terminal: [
      { text: '$ /x4:kickstart', type: 'command', delay: 0 },
      { text: '', type: 'output', delay: 400 },
      { text: 'What are you building?', type: 'output', delay: 600 },
      { text: '> A fitness tracker with AI coaching', type: 'info', delay: 1200 },
      { text: '', type: 'output', delay: 1600 },
      { text: 'Brainstorming features...', type: 'output', delay: 1800 },
      { text: '  1. Auth + user profile', type: 'info', delay: 2200 },
      { text: '  2. Workout logging', type: 'info', delay: 2500 },
      { text: '  3. AI coaching chat', type: 'info', delay: 2800 },
      { text: '  4. Progress dashboard', type: 'info', delay: 3100 },
      { text: '  ...4 more features', type: 'info', delay: 3400 },
      { text: '', type: 'output', delay: 3700 },
      { text: 'Designing UI for each feature...', type: 'output', delay: 3900 },
      { text: 'Sequencing build phases...', type: 'output', delay: 4400 },
      { text: 'Generating 8 PRDs...', type: 'output', delay: 4900 },
      { text: '', type: 'output', delay: 5300 },
      { text: '8 PRDs ready — run /x4:work to start building', type: 'success', delay: 5500 },
    ],
  },
  {
    id: 'build',
